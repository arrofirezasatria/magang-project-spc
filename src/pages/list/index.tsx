  ...
  return (
    ...
    <Container>
      <Grid>
        ...
        <Box sx={{ margin: { xs: "0", md: "0 30px" }, textAlign: "left", marginBottom: { xs: "85px", md: "110px" } }}>
          <Typography sx={{ fontWeight: "medium", lineHeight: "33px", fontSize: { xs: "18px", md: "24px" }, marginBottom: { xs: "18px", md: "24px" } }}>
            Our selection of concrete effect products range from small-format wall options with a stunning weathered effect, to large-format structured flooring products with PTV 36+ slip resistance ratings. Tile your next project here with
            products ideal for residential or commercial applications, and everything in between.
          </Typography>
      ...
      <Grid >
        ...
        <Grid >
          <Box display="flex" flexDirection={{ xs: "column", lg: "row" }} sx={{ marginTop: { xs: "60px", md: "0" }, alignItems:{xs: "center"}}}>
            <Box sx={{ width: "359px", marginRight: {xs:"0", md:"30px"} }}>
              ...
              <Typography sx={{ marginTop: "20px", textTransform: "uppercase", fontWeight: "bold", letterSpacing: "2px", textAlign: "center", fontSize: "24px" }}>Esential</Typography>
              ...
              <Box display="flex" flexDirection="row" sx={{ justifyContent: "center", marginTop: "18px" }}>
                <Box display="flex" flexDirection="row" sx={{ lineHeight: "25px", marginRight: "20px" }}>
                  <Box sx={{ width: "25px", height: "25px", position: "relative", marginRight: "15px" }}>
            ...
            <Box sx={{ width: "359px", marginRight: "30px", marginTop: { xs: "24px", md: "0" } }}>
              <Box sx={{ position: "relative", width: "359px", height: "462px" }}>
                <Image src={"/static/images/contoh.jpg"} fill alt={""} />
              </Box>
              <Typography sx={{ marginTop: "20px", textTransform: "uppercase", fontWeight: "bold", letterSpacing: "2px", textAlign: "center", fontSize: "24px" }}>Esential</Typography>
          ...
          <Box display="flex" sx={{ justifyContent: "center", marginTop: "50px", marginBottom: "152px" }}>
            <Button sx={{ textTransform: "capitalize", border: "1px solid #000", color: "#000", padding: "8px 10px 5px", borderRadius: "5px" }}>View All Product Ranges</Button>
          </Box>
        </Grid>
      </Grid>
      <Grid>
