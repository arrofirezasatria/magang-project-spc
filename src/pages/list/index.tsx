                    ...
                    <Box sx={{ cursor: "pointer" }}>
                      ...
                      >
                        {item.attributes.isNew && ( 
                          <Box sx={{ backgroundColor: "black", width: "80px", zIndex: "1", position: "relative", mt: "10px" }}>
                            <Typography sx={{ textAlign: "center", color: "white", fontWeight: "bold", fontSize: "20px", letterSpacing: "2px" }}>NEW</Typography>
                          </Box>
                        )}
