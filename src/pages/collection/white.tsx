...
export default function White(props: any) {
  const pageTitle = props.white.data[0]?.attributes.tile_color.data.attributes.Name;
  const pageShortDescription = props.white.data[0]?.attributes.tile_color.data.attributes.Short_Description;
  const pageImage = props.white.data[0]?.attributes.motif.data.attributes.Image_Hero_2880x1138px.data.attributes.url;
  const pageDescription = props.white.data[0]?.attributes.tile_color.data.attributes.Description || "No data Description";
...
export const getStaticProps = async () => {
  const res = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products?pagination[pageSize]=999&populate=deep,10&filters[tile_color][Name][$eq]=White", {
    headers: {
  ...
  const White = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products?pagination[pageSize]=1&populate=deep,10&filters[tile_color][Name][$eq]=White", {
    headers: {
      Authorization: `Bearer `,
    },
  });
  const white = await White.json();
