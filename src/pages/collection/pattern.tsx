...
export default function Pattern(props: any) {
  const pageTitle = props.Pattern.data[0]?.attributes.tile_color.data.attributes.Name;
  const pageShortDescription = props.Pattern.data[0]?.attributes.tile_color.data.attributes.Short_Description;
  const pageImage = props.Pattern.data[0]?.attributes.motif.data.attributes.Image_Hero_2880x1138px.data.attributes.url;
  const pageDescription = props.Pattern.data[0]?.attributes.tile_color.data.attributes.Description || "No data Description";
...
export const getStaticProps = async () => {
  const res = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products?pagination[pageSize]=999&populate=deep,10&filters[tile_color][Name][$eq]=Pattern", {
    headers: {
  ...
  const Pattern = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products?pagination[pageSize]=2&populate=deep,10&filters[tile_color][Name][$eq]=Pattern", {
    headers: {
      Authorization: `Bearer `,
    },
  });
  const pattern = await Pattern.json();
  const responseAlt1 = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products/" + 54 + "?populate=deep,10", {
    headers: {
      Authorization: `Bearer `,
    },
  });
  ...
  const responseAlt2 = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products/" + 45 + "?populate=deep,10", {
    headers: {
      Authorization: `Bearer `,
    },
  });
  ...
  const responseAlt3 = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products/" + 60 + "?populate=deep,10", {
    headers: {
      Authorization: `Bearer `,
    },
  });
