...
export default function Cream(props: any) {
  const pageTitle = props.Cream.data[0]?.attributes.tile_color.data.attributes.Name;
  const pageShortDescription = props.Cream.data[0]?.attributes.tile_color.data.attributes.Short_Description;
  const pageImage = props.Cream.data[1]?.attributes.motif.data.attributes.Image_Hero_2880x1138px.data.attributes.url;
  const pageDescription = props.Cream.data[0]?.attributes.tile_color.data.attributes.Description || "No data Description";
  return (
    <>
...
export const getStaticProps = async () => {
  const res = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products?pagination[pageSize]=999&populate=deep,10&filters[tile_color][Name][$eq]=Cream", {
    headers: {
  ...
  const cream = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products?pagination[pageSize]=2&populate=deep,10&filters[tile_color][Name][$eq]=Cream", {
    headers: {
      Authorization: `Bearer `,
    },
  });
  const Cream = await cream.json();
  const responseAlt1 = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products/" + 105 + "?populate=deep,10", {
    headers: {
      Authorization: `Bearer `,
    },
  });
  ...
  const responseAlt2 = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products/" + 71 + "?populate=deep,10", {
    headers: {
      Authorization: `Bearer `,
    },
  });
  ...
  const responseAlt3 = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products/" + 265 + "?populate=deep,10", {
    headers: {
      Authorization: `Bearer `,
    },
  });
