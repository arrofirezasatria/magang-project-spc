...
export const getStaticProps = async () => {
  const res = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/motifs?pagination[pageSize]=999&populate=*&filters[product_varians][Varian][$eq]=Infinity", {
    headers: {
  ...
  const infinity = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/motifs?pagination[pageSize]=1&populate=*&filters[product_varians][Varian][$eq]=Infinity", {
    headers: {
      Authorization: `Bearer `,
    },
  });

  const Infinity = await infinity.json();
  const responseAlt1 = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products/" + 166 + "?populate=deep,10", {
    headers: {
      Authorization: `Bearer `,
    },
  });
  ...
  const responseAlt2 = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products/" + 171 + "?populate=deep,10", {
    headers: {
      Authorization: `Bearer `,
    },
  });
  ...
  const responseAlt3 = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products/" + 67 + "?populate=deep,10", {
    headers: {
      Authorization: `Bearer `,
    },
  });
