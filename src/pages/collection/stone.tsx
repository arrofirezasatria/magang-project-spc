...
export default function stone(props: any) {
  ...
  const pageShortDescription =props.stone.data[0]?.attributes.style_motifs.data[0]?.attributes.Short_Description;
...
export const getStaticProps = async () => {
  const res = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/motifs?pagination[pageSize]=999&populate=*&filters[style_motifs][Style][$eq]=Stone", {
    headers: {
  ...
  const stone = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/motifs?pagination[pageSize]=1&populate=*&filters[style_motifs][Style][$eq]=Stone", {
    headers: {
      Authorization: `Bearer `,
    },
  });

  const Stone = await stone.json();
  const responseAlt1 = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products/" + 239 + "?populate=deep,10", {
    headers: {
      Authorization: `Bearer `,
    },
  });
  ...
  const responseAlt2 = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products/" + 229 + "?populate=deep,10", {
    headers: {
      Authorization: `Bearer `,
    },
  });
  ...
  const responseAlt3 = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products/" + 299 + "?populate=deep,10", {
    headers: {
      Authorization: `Bearer `,
    },
  });
