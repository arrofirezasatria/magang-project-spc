...
export default function Charcoal(props: any) {
  const pageTitle = props.Charcoal.data[0]?.attributes.tile_color.data.attributes.Name;
  const pageShortDescription = props.Charcoal.data[0]?.attributes.tile_color.data.attributes.Short_Description;
  const pageImage = props.Charcoal.data[0]?.attributes.motif.data.attributes.Image_Hero_2880x1138px.data.attributes.url;
  const pageDescription = props.Charcoal.data[0]?.attributes.tile_color.data.attributes.Description || "No data Description";
  return (
    <>
...
export const getStaticProps = async () => {
  const res = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products?pagination[pageSize]=999&populate=deep,10&filters[tile_color][Name][$eq]=Charcoal", {
    headers: {
  ...
  const charcoal = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products?pagination[pageSize]=2&populate=deep,10&filters[tile_color][Name][$eq]=Charcoal", {
    headers: {
      Authorization: `Bearer `,
    },
  });
  const Charcoal = await charcoal.json();
  const responseAlt1 = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products/" + 101 + "?populate=deep,10", {
    headers: {
      Authorization: `Bearer `,
    },
  });
  ...
  const responseAlt2 = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products/" + 220 + "?populate=deep,10", {
    headers: {
      Authorization: `Bearer `,
    },
  });
  ...
  const responseAlt3 = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/products/" + 79 + "?populate=deep,10", {
    headers: {
      Authorization: `Bearer `,
    },
  });
