...
export default function Porcelain(props: any) {
  const pageTitle = props.porcelain.data[0]?.attributes.tile_type.data.attributes.Type;
  const pageShortDescription = props.porcelain.data[0]?.attributes.tile_type.data.attributes.Short_Description;
  const pageImage = props.porcelain.data[0]?.attributes.Image_Hero_2880x1138px.data.attributes.url;
  const pageDescription = props.porcelain.data[0]?.attributes.tile_type.data.attributes.Description || "No data Description";
...
export const getStaticProps = async () => {
  const res = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/motifs?pagination[pageSize]=999&populate=*&filters[tile_type][Type][$eq]=Porcelain", {
    headers: {
  ...
  const Porcelain = await fetch("https://strapi-app-tnshv.ondigitalocean.app/api/motifs?pagination[pageSize]=1&populate=*&filters[tile_type][Type][$eq]=Porcelain", {
    headers: {
      Authorization: `Bearer `,
    },
  });
  const porcelain = await Porcelain.json();
