        ...
        <Container>
          <Toolbar>
            ...
            <Stack direction={"row"} display={"flex"} alignItems={"center"}>
              <Button onClick={toggleDrawer} sx={{ color: "black" }}>Cart</Button>
            ...
            {isCartExist ? (
              <>
                <List sx={{
                  ...
                  <ListItem sx={{ borderBottom: '1px solid #ededed', py: '1rem' }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
                      <Box sx={{ display: 'flex' }}>
                        <Box>
                          ...
                          <Box sx={{ bgcolor: '#ededed', width: '65px', height: '65px', borderRadius: '0.375rem' }}>
                            {/* <Image src={ } alt="" fill /> */}
                          </Box>
                        </Box>
                        <Box sx={{ ml: '16px', overflowWrap: 'break-word', flexWrap: 'wrap', maxWidth: '130px' }}>
                          <Typography sx={{ fontSize: '16px', fontWeight: 'medium' }}>Le Product Ranges</Typography>
                          <Typography sx={{ fontSize: '14px', color: '#737373' }}>Black / 120x60cm</Typography>
                        </Box>
                      </Box>
                      <Box>
                        <Typography sx={{ fontSize: '14px' }}>Rp. 123.123.123</Typography>
