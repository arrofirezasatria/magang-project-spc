  ...
  return (
    <>
      <Box sx={{position: 'relative', pt: '40px'}}>
        <Box sx={{display: 'flex', justifyContent: 'center', position: 'relative', pb: '30px', mb: '40px', textAlign: 'center'}}>
      ...
      <Grid container spacing={0} sx={{mt: '44px', px: {xs: '0px', md: '20px'}, mb: '40px'}}>
        {productRangesImg.map((productRangesImg, index) => (
          <Grid item key={index} xs={12} md={4} sx={{px: {xs: '0px', md: '20px'}, width: '100%', mb: {xs: '20px', md: '0px'}}}>
            <Box sx={{
              height: '353px', 
              width: '100%', 
              position: 'relative',
              ...
              <Link href='#'>
                <Box
                  ...
                  <Box sx={{
                    ...
                    '&:hover': {
                      transition: [
                        'max-height .3s ease-out','margin .3s ease-out','opacity .3s linear',
                      ],
                    }
                    }}>
