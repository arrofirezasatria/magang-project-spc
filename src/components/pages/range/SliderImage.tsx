...
export default function SliderImage(props) {
  ...
  const sliderData = [
    {
      imageUrl: props?.productOnly?.Image_Ambience?.data[0].attributes.formats.large.url,
    ...
    {
      imageUrl: props?.productOnly?.Image_Ambience?.data[1].attributes.formats.large.url,
